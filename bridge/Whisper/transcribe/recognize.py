from transcribe.ringbuffer import RingBuffer
from transcribe.streamReader import open_stream
...
class Recognizer():
    ...
    def speech_recognition(
        ...
        if use_vad:
            from transcribe.VoiceActivityDetection import VoiceActivityDetection
        ...
        try:
            while ffmpeg_process.poll() is None:
                ...
                yield decoded_language + " " + decoded_text + "\n"
